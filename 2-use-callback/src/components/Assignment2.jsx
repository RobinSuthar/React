...
// when the button is clicked. Use useCallback to memoize the event handler function that triggers the alert, ensuring it's not recreated on every render.
...
const Alert = memo(function x({ showAlert }) {
  console.log("Alert Button Rendeneered");
